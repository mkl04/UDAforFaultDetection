...
class DexiNed(nn.Module):
    ...
    def __init__(self, f1=32, branches=['bottle']):
        ...
        if 'blk4' in branches:
            self.conv_blk4  = nn.Conv2d(f1*16, 4, kernel_size=3, padding=1)
        if 'out4' in branches:
            self.conv_out4  = nn.Conv2d(f1*16, 4, kernel_size=3, padding=1)
    ...
    def forward(self, x):
        ...
        for branch_name in self.branches:
            ...
            if 'blk4' in branch_name:
                branch = self.conv_blk4(block_4)
